...
export default function Home() {
  ...
  */
      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} Enigma
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} Enigmatic Mango LP tokens
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              ...
              <div>
                ...
                <div className={styles.inputDiv}>
                  {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                  {`You will need ${utils.formatEther(addCDTokens)} Enigma`}
                </div>
                <button className={styles.button1} onClick={_addLiquidity}>
                  Add
                </button>
            ...
            <div>
              ...
              <div className={styles.inputDiv}>
                {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
                {`You will get ${utils.formatEther(removeCD)} Enigma and ${utils.formatEther(removeEther)} Eth`}
              </div>
  ...
  return (
    <div>
      <Head>
        <title>EnigmaticDex</title>
        <meta name="description" content="Whitelist-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to the Enigmatic Mango!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Enigma
          </div>
          <div>
            <button
